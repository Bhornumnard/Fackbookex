...
import "../style/log_in_page/Right.css"
        ...
        return (
            <Col className="RightBody">
                ...
                <Row className="rowInLeft">
                    ...
                    <Col span={24} className="inputRight"><input type="text" placeholder="หมายเลขโทรศัพท์มือถือหรืออีเมล์" /></Col>
                    ...
                    <Col span={24} className="inputRight">
                        ...
                        <Row>
                           <span> <input type="radio"></input><label>หญิง</label></span>
                           <span> <input type="radio"></input><label>ชาย</label></span>
                           <span> <input type="radio"></input><label>กำหนดเอง</label></span>
                            <span> <i class="img sp_UQETc8Y6QpO_1_5x sx_bb491c"></i> </span>
                        </Row>
